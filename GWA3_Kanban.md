...
| GWA3-104 | Conset Crafting (Grail, Essence, Armor at Embark Beach) | L | 024, 026 | `done` |
| GWA3-105 | Xunlai Chest Operations (deposit/withdraw items + gold) | M | 018, 026 | `done` |
| GWA3-106 | Wipe Recovery (smart restart waypoints, morale-based DP) | M | 026 | `done` |
...
| GWA3-137 | CanUseSkill: Zephyr + Adrenaline + Pressure Gates | M | 124 | `done` |
| GWA3-138 | Loot Policy: Quest Items + Type Rules + Inventory Guard | L | 098 | `done` |
