...
#include "FrostmawsBurrowsTestSupport.h"
#include <bots/common/BotFramework.h>
#include <bots/frostmaws_burrows/FrostmawsBurrowsBot.h>
#include <gwa3/testing/TestFramework.h>

// --- tests/test_frostmaws_blessing_anchor_data_matches_autoit.cpp ---
namespace GWA3::Tests::Consolidated::test_frostmaws_blessing_anchor_data_matches_autoit {
...
// --- tests/test_frostmaws_burrows_bot.cpp ---
namespace GWA3::Tests::Consolidated::test_frostmaws_burrows_bot {
...
// --- tests/test_frostmaws_quest_bootstrap_constants.cpp ---
namespace GWA3::Tests::Consolidated::test_frostmaws_quest_bootstrap_constants {
...
GWA3_TEST(frostmaws_quest_bootstrap_constants, {
    ...
    GWA3_ASSERT_EQ(plan.entry_map_id, GWA3::MapIds::JAGA_MORAINE);
    GWA3_ASSERT_EQ(plan.reset_map_id, GWA3::MapIds::SIFHALLA);
    GWA3_ASSERT_EQ(plan.target_map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL1);
    GWA3_ASSERT_EQ(GWA3::DungeonQuest::GetExpandedDialogCount(plan), 6);
})

} // namespace GWA3::Tests::Consolidated::test_frostmaws_quest_bootstrap_constants

// --- tests/test_frostmaws_route_definition_counts_and_maps.cpp ---
namespace GWA3::Tests::Consolidated::test_frostmaws_route_definition_counts_and_maps {
...
GWA3_TEST(frostmaws_route_definition_counts_and_maps, {
    ...
    GWA3_ASSERT_EQ(run1.map_id, GWA3::MapIds::SIFHALLA);
    GWA3_ASSERT_EQ(run1.next_map_id, GWA3::MapIds::JAGA_MORAINE);
    GWA3_ASSERT_EQ(run1.waypoint_count, 3);

    GWA3_ASSERT_EQ(run2.map_id, GWA3::MapIds::JAGA_MORAINE);
    GWA3_ASSERT_EQ(run2.next_map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL1);
    GWA3_ASSERT_EQ(run2.waypoint_count, 9);

    GWA3_ASSERT_EQ(level1.map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL1);
    GWA3_ASSERT_EQ(level1.next_map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL2);
    GWA3_ASSERT_EQ(level1.waypoint_count, 5);

    GWA3_ASSERT_EQ(level2.map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL2);
    GWA3_ASSERT_EQ(level2.next_map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL3);
    GWA3_ASSERT_EQ(level2.waypoint_count, 11);

    GWA3_ASSERT_EQ(level3.map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL3);
    GWA3_ASSERT_EQ(level3.next_map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL4);
    GWA3_ASSERT_EQ(level3.waypoint_count, 21);

    GWA3_ASSERT_EQ(level4.map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL4);
    GWA3_ASSERT_EQ(level4.next_map_id, GWA3::MapIds::FROSTMAWS_BURROWS_LVL5);
    GWA3_ASSERT_EQ(level4.waypoint_count, 21);
})

} // namespace GWA3::Tests::Consolidated::test_frostmaws_route_definition_counts_and_maps

// --- tests/test_frostmaws_route_lookup_and_missing_level5_source_are_explicit.cpp ---
namespace GWA3::Tests::Consolidated::test_frostmaws_route_lookup_and_missing_level5_source_are_explicit {

GWA3_TEST(frostmaws_route_lookup_and_missing_level5_source_are_explicit, {
    const auto* jaga = Frost::FindRouteDefinitionByMapId(GWA3::MapIds::JAGA_MORAINE);
    const auto* level4 = Frost::FindRouteDefinitionByMapId(GWA3::MapIds::FROSTMAWS_BURROWS_LVL4);
    const auto* missing = Frost::FindRouteDefinitionByMapId(GWA3::MapIds::FROSTMAWS_BURROWS_LVL5);
    ...
    GWA3_ASSERT_EQ(GWA3::DialogIds::FrostmawsBurrows::QUEST, 0x832A01u);
...
// --- tests/test_frostmaws_waypoint_execution_plan_defaults_to_standard_move.cpp ---
namespace GWA3::Tests::Consolidated::test_frostmaws_waypoint_execution_plan_defaults_to_standard_move {
