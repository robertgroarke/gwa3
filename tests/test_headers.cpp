// : Compile-time verification of all packet header constants.
// Every value is checked against the current legacy GWA source.
...
static_assert(P::ATTACK_AGENT                      == 0x26, "ATTACK_AGENT");
...
static_assert(P::PARTY_SEARCH_REQUEST_REPLY        == 0xAD, "PARTY_SEARCH_REQUEST_REPLY");
