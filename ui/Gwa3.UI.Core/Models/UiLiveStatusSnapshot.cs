...
public sealed record UiLiveStatusSnapshot
{
    ...
    public string RuntimePreviousStep { get; init; } = "";
    public string RuntimeCurrentStep { get; init; } = "";
    public string RuntimeNextStep { get; init; } = "";
    public string RuntimeStateMachine { get; init; } = "";
    public string RuntimeMap { get; init; } = "";
    public string RuntimeHealth { get; init; } = "";
    public string RuntimePosition { get; init; } = "";
    public string RuntimeTarget { get; init; } = "";
    public string RuntimePathing { get; init; } = "";
    public string RuntimeCasting { get; init; } = "";
    public string RuntimeSkillbar { get; init; } = "";
    public string RuntimeActionQueue { get; init; } = "";
    public string RuntimeOverwatch { get; init; } = "";
    public string RuntimeLastUpdate { get; init; } = "";
