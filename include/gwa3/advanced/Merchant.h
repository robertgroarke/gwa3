...
struct SellAtMerchantOptions {
    ...
    MerchantContextOptions merchant = {};
    AdvancedItemActions::SellOptions sell = {};
};

struct DepositAtStorageOptions {
    NpcServiceOptions npc = {};
    AdvancedItemActions::DepositOptions deposit = {};
};
...
struct MaintenanceStateOptions {
    ...
    AdvancedItemActions::UseItemOptions dp_removal = {5000u};
    AdvancedInventory::UnclaimedItemClaimOptions unclaimed_items = {};
    const char* log_prefix = nullptr;
