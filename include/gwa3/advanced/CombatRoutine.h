...
struct SkillExecutionContext {
    AdvancedSkill::CachedSkill* skill_cache = nullptr;
...
struct SkillUseResolution {
    ...
    AdvancedSkill::CachedSkill* skill = nullptr;
...
struct CombatSessionState {
    AdvancedSkill::CachedSkill skill_cache[8] = {};
...
bool RefreshSkillCache(CombatSessionState& session,
                       const AdvancedSkill::SkillCacheLogCallbacks* logCallbacks = nullptr);
