...
constexpr RouteDefinition kStages[] = {
    {"RunRataSumToMagusStones", MAP_RATA_SUM, MAP_MAGUS_STONES, kRunRataSumToMagusStones, static_cast<int>(sizeof(kRunRataSumToMagusStones) / sizeof(kRunRataSumToMagusStones[0]))},
    {"RunMagusToDungeon", MAP_MAGUS_STONES, MAP_ARACHNIS_HAUNT_LVL1, kRunMagusToDungeon, static_cast<int>(sizeof(kRunMagusToDungeon) / sizeof(kRunMagusToDungeon[0]))},
    {"Level1", MAP_ARACHNIS_HAUNT_LVL1, MAP_ARACHNIS_HAUNT_LVL2, kLevel1Dispatch, static_cast<int>(sizeof(kLevel1Dispatch) / sizeof(kLevel1Dispatch[0]))},
    {"Level2", MAP_ARACHNIS_HAUNT_LVL2, MAP_MAGUS_STONES, kLevel2Dispatch, static_cast<int>(sizeof(kLevel2Dispatch) / sizeof(kLevel2Dispatch[0]))},
};

constexpr RouteDefinition kRoutes[] = {
    {"RunRataSumToMagusStones", MAP_RATA_SUM, MAP_MAGUS_STONES, kRunRataSumToMagusStones, static_cast<int>(sizeof(kRunRataSumToMagusStones) / sizeof(kRunRataSumToMagusStones[0]))},
    {"RunMagusToDungeon", MAP_MAGUS_STONES, 0u, kRunMagusToDungeon, static_cast<int>(sizeof(kRunMagusToDungeon) / sizeof(kRunMagusToDungeon[0]))},
    {"Level1Phase1", MAP_ARACHNIS_HAUNT_LVL1, 0u, kLevel1Phase1, static_cast<int>(sizeof(kLevel1Phase1) / sizeof(kLevel1Phase1[0]))},
    {"Level1Phase2", MAP_ARACHNIS_HAUNT_LVL1, 0u, kLevel1Phase2, static_cast<int>(sizeof(kLevel1Phase2) / sizeof(kLevel1Phase2[0]))},
    {"Level1Phase3", MAP_ARACHNIS_HAUNT_LVL1, 0u, kLevel1Phase3, static_cast<int>(sizeof(kLevel1Phase3) / sizeof(kLevel1Phase3[0]))},
    {"Level1Phase4", MAP_ARACHNIS_HAUNT_LVL1, 0u, kLevel1Phase4, static_cast<int>(sizeof(kLevel1Phase4) / sizeof(kLevel1Phase4[0]))},
    {"Level1Exit", MAP_ARACHNIS_HAUNT_LVL1, MAP_ARACHNIS_HAUNT_LVL2, kLevel1Exit, static_cast<int>(sizeof(kLevel1Exit) / sizeof(kLevel1Exit[0]))},
    {"Level2Phase1Approach", MAP_ARACHNIS_HAUNT_LVL2, 0u, kLevel2Phase1Approach, static_cast<int>(sizeof(kLevel2Phase1Approach) / sizeof(kLevel2Phase1Approach[0]))},
    {"Level2Phase1Transit", MAP_ARACHNIS_HAUNT_LVL2, 0u, kLevel2Phase1Transit, static_cast<int>(sizeof(kLevel2Phase1Transit) / sizeof(kLevel2Phase1Transit[0]))},
    {"Level2Phase2", MAP_ARACHNIS_HAUNT_LVL2, 0u, kLevel2Phase2, static_cast<int>(sizeof(kLevel2Phase2) / sizeof(kLevel2Phase2[0]))},
    {"Level2Phase3", MAP_ARACHNIS_HAUNT_LVL2, 0u, kLevel2Phase3, static_cast<int>(sizeof(kLevel2Phase3) / sizeof(kLevel2Phase3[0]))},
};
...
constexpr uint32_t kRewardDialogs[] = {
    DIALOG_REWARD_ACCEPT,
    DIALOG_ARACHNIS_REWARD,
};

constexpr uint32_t kAcceptDialogs[] = {
    DIALOG_ACCEPT,
    DIALOG_ARACHNIS_QUEST,
};

constexpr uint32_t kCompletionDialogs[] = {
    DIALOG_ACCEPT,
    DIALOG_ARACHNIS_COMPLETION,
};
...
QuestCyclePlan GetQuestCyclePlan() {
    ...
    plan.start_map_id = MAP_MAGUS_STONES;
    plan.dungeon_map_id = MAP_ARACHNIS_HAUNT_LVL1;
    return plan;
}
