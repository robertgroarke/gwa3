...
constexpr RouteDefinition kRoutes[] = {
    {"RunSifhallaToJagaMoraine", MAP_SIFHALLA, MAP_JAGA_MORAINE, kRunJagaWaypoints, static_cast<int>(sizeof(kRunJagaWaypoints) / sizeof(kRunJagaWaypoints[0]))},
    {"RunJagaMoraineToDungeon", MAP_JAGA_MORAINE, MAP_FROSTMAWS_BURROWS_LVL1, kRunToDungeonWaypoints, static_cast<int>(sizeof(kRunToDungeonWaypoints) / sizeof(kRunToDungeonWaypoints[0]))},
    {"Level1", MAP_FROSTMAWS_BURROWS_LVL1, MAP_FROSTMAWS_BURROWS_LVL2, kLevel1Waypoints, static_cast<int>(sizeof(kLevel1Waypoints) / sizeof(kLevel1Waypoints[0]))},
    {"Level2", MAP_FROSTMAWS_BURROWS_LVL2, MAP_FROSTMAWS_BURROWS_LVL3, kLevel2Waypoints, static_cast<int>(sizeof(kLevel2Waypoints) / sizeof(kLevel2Waypoints[0]))},
    {"Level3", MAP_FROSTMAWS_BURROWS_LVL3, MAP_FROSTMAWS_BURROWS_LVL4, kLevel3Waypoints, static_cast<int>(sizeof(kLevel3Waypoints) / sizeof(kLevel3Waypoints[0]))},
    {"Level4", MAP_FROSTMAWS_BURROWS_LVL4, MAP_FROSTMAWS_BURROWS_LVL5, kLevel4Waypoints, static_cast<int>(sizeof(kLevel4Waypoints) / sizeof(kLevel4Waypoints[0]))},
};
...
BootstrapPlan GetQuestBootstrapPlan() {
    ...
    plan.entry_map_id = MAP_JAGA_MORAINE;
    plan.reset_map_id = MAP_SIFHALLA;
    plan.target_map_id = MAP_FROSTMAWS_BURROWS_LVL1;
    return plan;
}
