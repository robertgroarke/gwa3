...
constexpr RouteDefinition kDispatchRoutes[] = {
    {"RunOlafsteadToVarajarFells", MAP_OLAFSTEAD, MAP_VARAJAR_FELLS_1, kDispatchRunOlafstead, static_cast<int>(sizeof(kDispatchRunOlafstead) / sizeof(kDispatchRunOlafstead[0]))},
    {"VarajarFells", MAP_VARAJAR_FELLS_1, MAP_RAVENS_POINT_LVL1, kDispatchVarajar, static_cast<int>(sizeof(kDispatchVarajar) / sizeof(kDispatchVarajar[0]))},
    {"Level1", MAP_RAVENS_POINT_LVL1, MAP_RAVENS_POINT_LVL2, kDispatchLevel1, static_cast<int>(sizeof(kDispatchLevel1) / sizeof(kDispatchLevel1[0]))},
    {"Level2", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL3, kDispatchLevel2, static_cast<int>(sizeof(kDispatchLevel2) / sizeof(kDispatchLevel2[0]))},
    {"Level3", MAP_RAVENS_POINT_LVL3, MAP_VARAJAR_FELLS_1, kDispatchLevel3, static_cast<int>(sizeof(kDispatchLevel3) / sizeof(kDispatchLevel3[0]))},
};

constexpr RouteDefinition kRoutes[] = {
    {"RunOlafsteadToVarajarFells", MAP_OLAFSTEAD, MAP_VARAJAR_FELLS_1, kDispatchRunOlafstead, static_cast<int>(sizeof(kDispatchRunOlafstead) / sizeof(kDispatchRunOlafstead[0]))},
    {"RunVarajarToBlessing", MAP_VARAJAR_FELLS_1, MAP_VARAJAR_FELLS_1, kRunVarajarToBlessing, static_cast<int>(sizeof(kRunVarajarToBlessing) / sizeof(kRunVarajarToBlessing[0]))},
    {"QuestApproach", MAP_VARAJAR_FELLS_1, MAP_RAVENS_POINT_LVL1, kQuestApproach, static_cast<int>(sizeof(kQuestApproach) / sizeof(kQuestApproach[0]))},
    {"QuestReturn", MAP_VARAJAR_FELLS_1, MAP_VARAJAR_FELLS_1, kQuestReturn, static_cast<int>(sizeof(kQuestReturn) / sizeof(kQuestReturn[0]))},
    {"Level1Dispatch", MAP_RAVENS_POINT_LVL1, MAP_RAVENS_POINT_LVL2, kDispatchLevel1, static_cast<int>(sizeof(kDispatchLevel1) / sizeof(kDispatchLevel1[0]))},
    {"Level1Torch1", MAP_RAVENS_POINT_LVL1, MAP_RAVENS_POINT_LVL1, kLevel1Torch1, static_cast<int>(sizeof(kLevel1Torch1) / sizeof(kLevel1Torch1[0]))},
    {"Level1Torch2", MAP_RAVENS_POINT_LVL1, MAP_RAVENS_POINT_LVL1, kLevel1Torch2, static_cast<int>(sizeof(kLevel1Torch2) / sizeof(kLevel1Torch2[0]))},
    {"Level1DoorKey", MAP_RAVENS_POINT_LVL1, MAP_RAVENS_POINT_LVL1, kLevel1DoorKey, static_cast<int>(sizeof(kLevel1DoorKey) / sizeof(kLevel1DoorKey[0]))},
    {"Level1DoorBacktrack", MAP_RAVENS_POINT_LVL1, MAP_RAVENS_POINT_LVL1, kLevel1DoorBacktrack, static_cast<int>(sizeof(kLevel1DoorBacktrack) / sizeof(kLevel1DoorBacktrack[0]))},
    {"Level1Exit", MAP_RAVENS_POINT_LVL1, MAP_RAVENS_POINT_LVL2, kLevel1Exit, static_cast<int>(sizeof(kLevel1Exit) / sizeof(kLevel1Exit[0]))},
    {"Level2Dispatch", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL3, kDispatchLevel2, static_cast<int>(sizeof(kDispatchLevel2) / sizeof(kDispatchLevel2[0]))},
    {"Level2Torch1", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL2, kLevel2Torch1, static_cast<int>(sizeof(kLevel2Torch1) / sizeof(kLevel2Torch1[0]))},
    {"Level2Torch2", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL2, kLevel2Torch2, static_cast<int>(sizeof(kLevel2Torch2) / sizeof(kLevel2Torch2[0]))},
    {"Level2Torch3", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL2, kLevel2Torch3, static_cast<int>(sizeof(kLevel2Torch3) / sizeof(kLevel2Torch3[0]))},
    {"Level2BossKey", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL2, kLevel2BossKey, static_cast<int>(sizeof(kLevel2BossKey) / sizeof(kLevel2BossKey[0]))},
    {"Level2BossKeyBacktrack", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL2, kLevel2BossKeyBacktrack, static_cast<int>(sizeof(kLevel2BossKeyBacktrack) / sizeof(kLevel2BossKeyBacktrack[0]))},
    {"Level2Door", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL2, kLevel2Door, static_cast<int>(sizeof(kLevel2Door) / sizeof(kLevel2Door[0]))},
    {"Level2Exit", MAP_RAVENS_POINT_LVL2, MAP_RAVENS_POINT_LVL3, kLevel2Exit, static_cast<int>(sizeof(kLevel2Exit) / sizeof(kLevel2Exit[0]))},
    {"Level3Approach", MAP_RAVENS_POINT_LVL3, MAP_RAVENS_POINT_LVL3, kLevel3Approach, static_cast<int>(sizeof(kLevel3Approach) / sizeof(kLevel3Approach[0]))},
    {"Level3BossLoop", MAP_RAVENS_POINT_LVL3, MAP_VARAJAR_FELLS_1, kLevel3BossLoop, static_cast<int>(sizeof(kLevel3BossLoop) / sizeof(kLevel3BossLoop[0]))},
};
...
bool UsesAggroTraversal(RouteId routeId) {
    ...
    return route.map_id == MAP_RAVENS_POINT_LVL1 ||
           route.map_id == MAP_RAVENS_POINT_LVL2 ||
           route.map_id == MAP_RAVENS_POINT_LVL3;
}
...
QuestCyclePlan GetQuestCyclePlan() {
    ...
    plan.start_map_id = MAP_VARAJAR_FELLS_1;
    plan.dungeon_map_id = MAP_RAVENS_POINT_LVL1;
    return plan;
}
