...
bool ExecuteRoute(RouteId routeId, bool waitForTransition) {
    ...
    case RouteId::RunDoomloreToDalada:
        return ZoneThroughPoint(-15366.0f, 13553.0f, MAP_DALADA_UPLANDS);
    case RouteId::RunDaladaToSacnoth:
        return ZoneThroughPoint(14390.0f, -20300.0f, MAP_SACNOTH_VALLEY);
    case RouteId::Level1:
        return ZoneThroughPoint(-16946.0f, -3014.0f, MAP_CATACOMBS_OF_KATHANDRAX_LVL2);
    case RouteId::Level2:
        return ZoneThroughPoint(-16864.0f, -539.0f, MAP_CATACOMBS_OF_KATHANDRAX_LVL3);
    default:
        return true;
    }
}
...
bool ExecuteRewardChestFlow() {
    ...
    DungeonNavigation::MoveToAndWait(
        ...
        15000u,
        1000u,
        MAP_CATACOMBS_OF_KATHANDRAX_LVL3);
    ...
    return DungeonNavigation::WaitForMapId(MAP_SACNOTH_VALLEY, 180000u);
}
...
BotState HandleTownSetup(BotConfig&) {
    ...
    if (mapId == MAP_DOOMLORE_SHRINE || mapId == MAP_DALADA_UPLANDS || mapId == MAP_SACNOTH_VALLEY) {
        return BotState::Traveling;
    }
    if (mapId == MAP_CATACOMBS_OF_KATHANDRAX_LVL1 || mapId == MAP_CATACOMBS_OF_KATHANDRAX_LVL2 || mapId == MAP_CATACOMBS_OF_KATHANDRAX_LVL3) {
...
void Register() {
    ...
    cfg.hard_mode = true;
    cfg.target_map_id = MAP_CATACOMBS_OF_KATHANDRAX_LVL1;
