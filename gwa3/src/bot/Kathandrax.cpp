...
constexpr RouteDefinition kRoutes[] = {
    {"RunDoomloreToDalada", MAP_DOOMLORE_SHRINE, MAP_DALADA_UPLANDS, kRunToDaladaWaypoints, static_cast<int>(sizeof(kRunToDaladaWaypoints) / sizeof(kRunToDaladaWaypoints[0]))},
    {"RunDaladaToSacnoth", MAP_DALADA_UPLANDS, MAP_SACNOTH_VALLEY, kRunToSacnothWaypoints, static_cast<int>(sizeof(kRunToSacnothWaypoints) / sizeof(kRunToSacnothWaypoints[0]))},
    {"RunSacnothToDungeon", MAP_SACNOTH_VALLEY, MAP_CATACOMBS_OF_KATHANDRAX_LVL1, kRunToDungeonWaypoints, static_cast<int>(sizeof(kRunToDungeonWaypoints) / sizeof(kRunToDungeonWaypoints[0]))},
    {"Level1", MAP_CATACOMBS_OF_KATHANDRAX_LVL1, MAP_CATACOMBS_OF_KATHANDRAX_LVL2, kLevel1Waypoints, static_cast<int>(sizeof(kLevel1Waypoints) / sizeof(kLevel1Waypoints[0]))},
    {"Level2", MAP_CATACOMBS_OF_KATHANDRAX_LVL2, MAP_CATACOMBS_OF_KATHANDRAX_LVL3, kLevel2Waypoints, static_cast<int>(sizeof(kLevel2Waypoints) / sizeof(kLevel2Waypoints[0]))},
    {"Level3", MAP_CATACOMBS_OF_KATHANDRAX_LVL3, MAP_SACNOTH_VALLEY, kLevel3Waypoints, static_cast<int>(sizeof(kLevel3Waypoints) / sizeof(kLevel3Waypoints[0]))},
};
...
BootstrapPlan GetQuestBootstrapPlan() {
    ...
    plan.entry_map_id = MAP_SACNOTH_VALLEY;
    plan.target_map_id = MAP_CATACOMBS_OF_KATHANDRAX_LVL1;
    return plan;
}
...
WaypointExecutionPlan BuildWaypointExecutionPlan(RouteId routeId, int waypointIndex) {
    ...
    if (waypointIndex < 0 || waypointIndex >= route.waypoint_count) {
        return plan;
    }

    plan.waypoint = &route.waypoints[waypointIndex];
