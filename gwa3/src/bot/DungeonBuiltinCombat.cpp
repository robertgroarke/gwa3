...
namespace GWA3::Bot::DungeonBuiltinCombat {
...
int PickUpNearbyLoot(float maxRange) {
    ...
    return DungeonLoot::PickUpNearbyLoot(
        maxRange,
        &GWA3::Bot::DungeonBuiltinCombat::WaitMs,
        &GWA3::Bot::DungeonBuiltinCombat::IsPlayerOrPartyDead,
        options);
}

void SettleAfterLocalClear(uint32_t timeoutMs = 1500u) {
    // AutoIt/Froggy stop active combat before resuming travel. Do the same
