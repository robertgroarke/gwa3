...
constexpr RouteDefinition kRoutes[] = {
    {"RunDaladaToGrothmar", MAP_DALADA_UPLANDS, MAP_GROTHMAR_WARDOWNS, kRunToDaladaWaypoints, static_cast<int>(sizeof(kRunToDaladaWaypoints) / sizeof(kRunToDaladaWaypoints[0]))},
    {"RunGrothmarToSacnoth", MAP_GROTHMAR_WARDOWNS, MAP_SACNOTH_VALLEY, kRunToGrothmarWaypoints, static_cast<int>(sizeof(kRunToGrothmarWaypoints) / sizeof(kRunToGrothmarWaypoints[0]))},
    {"RunSacnothToDungeon", MAP_SACNOTH_VALLEY, MAP_RRAGARS_MENAGERIE_LVL1, kRunToDungeonWaypoints, static_cast<int>(sizeof(kRunToDungeonWaypoints) / sizeof(kRunToDungeonWaypoints[0]))},
    {"Level1", MAP_RRAGARS_MENAGERIE_LVL1, MAP_RRAGARS_MENAGERIE_LVL2, kLevel1Waypoints, static_cast<int>(sizeof(kLevel1Waypoints) / sizeof(kLevel1Waypoints[0]))},
    {"Level2", MAP_RRAGARS_MENAGERIE_LVL2, MAP_RRAGARS_MENAGERIE_LVL3, kLevel2Waypoints, static_cast<int>(sizeof(kLevel2Waypoints) / sizeof(kLevel2Waypoints[0]))},
    {"Level3", MAP_RRAGARS_MENAGERIE_LVL3, MAP_DOOMLORE_SHRINE, kLevel3Waypoints, static_cast<int>(sizeof(kLevel3Waypoints) / sizeof(kLevel3Waypoints[0]))},
};
