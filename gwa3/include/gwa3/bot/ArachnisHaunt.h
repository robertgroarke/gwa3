...
constexpr uint32_t MAP_MAGUS_STONES = 569u;
constexpr uint32_t MAP_ARACHNIS_HAUNT_LVL1 = 584u;
constexpr uint32_t MAP_ARACHNIS_HAUNT_LVL2 = 585u;
constexpr uint32_t MAP_RATA_SUM = 640u;

constexpr uint32_t DIALOG_ACCEPT = 0x801u;
constexpr uint32_t DIALOG_REWARD_ACCEPT = 0x8101u;
constexpr uint32_t DIALOG_ARACHNIS_REWARD = 0x831A07u;
constexpr uint32_t DIALOG_ARACHNIS_QUEST = 0x831A01u;
constexpr uint32_t DIALOG_ARACHNIS_COMPLETION = 0x831A02u;
