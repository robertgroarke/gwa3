...
constexpr uint32_t MAP_VARAJAR_FELLS_1 = 553u;
constexpr uint32_t MAP_RAVENS_POINT_LVL1 = 617u;
constexpr uint32_t MAP_RAVENS_POINT_LVL2 = 618u;
constexpr uint32_t MAP_RAVENS_POINT_LVL3 = 619u;
constexpr uint32_t MAP_OLAFSTEAD = 645u;

constexpr uint32_t QUEST_RAVENS_POINT = 0x343u;
constexpr uint32_t DIALOG_ACCEPT = 0x8101u;
constexpr uint32_t DIALOG_RAVENS_REWARD = 0x834307u;
constexpr uint32_t DIALOG_RAVENS_QUEST = 0x834301u;
