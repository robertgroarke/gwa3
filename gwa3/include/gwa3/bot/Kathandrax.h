...
constexpr uint32_t MAP_CATACOMBS_OF_KATHANDRAX_LVL1 = 570u;
constexpr uint32_t MAP_CATACOMBS_OF_KATHANDRAX_LVL2 = 571u;
constexpr uint32_t MAP_CATACOMBS_OF_KATHANDRAX_LVL3 = 676u;
constexpr uint32_t MAP_DALADA_UPLANDS = 647u;
constexpr uint32_t MAP_DOOMLORE_SHRINE = 648u;
constexpr uint32_t MAP_SACNOTH_VALLEY = 651u;
constexpr uint32_t QUEST_KATHANDRAXS_CRUSHER = 805u;
constexpr uint32_t DIALOG_ACCEPT = 0x8101u;
constexpr uint32_t DIALOG_KATHANDRAX_QUEST = 0x832501u;
