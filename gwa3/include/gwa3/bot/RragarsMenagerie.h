...
constexpr uint32_t MAP_RRAGARS_MENAGERIE_LVL1 = 573u;
constexpr uint32_t MAP_RRAGARS_MENAGERIE_LVL2 = 574u;
constexpr uint32_t MAP_RRAGARS_MENAGERIE_LVL3 = 575u;
constexpr uint32_t MAP_DALADA_UPLANDS = 647u;
constexpr uint32_t MAP_DOOMLORE_SHRINE = 648u;
constexpr uint32_t MAP_GROTHMAR_WARDOWNS = 649u;
