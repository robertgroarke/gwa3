#RequireAdmin
;~ Launch all 5 GW clients with Froggy bot, correct hero configs, Buy Consets DISABLED.
...
ConsoleWrite("=== Launching All 5 Bots (No Consets) ===" & @CRLF)
...
ConsoleWrite(@CRLF & "=== All 5 bots launched (Buy Consets DISABLED) ===" & @CRLF)
