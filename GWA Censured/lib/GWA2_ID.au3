...
Global Const $ID_REGION_CHINESE				= -2
...
Global Const $RANGE_SPELLCAST = 1085
Global Const $RANGE_LONGBOW = 1250
Global Const $RANGE_SPIRIT = 2500
Global Const $RANGE_COMPASS = 5000

Global Const $RANGE_ADJACENT_2 = 156^2
Global Const $RANGE_NEARBY_2 = 240^2
Global Const $RANGE_AREA_2 = 312^2
Global Const $RANGE_EARSHOT_2 = 1000^2
Global Const $RANGE_SPELLCAST_2 = 1085^2
Global Const $RANGE_LONGBOW_2 = 1250^2
Global Const $RANGE_SPIRIT_2 = 2500^2
Global Const $RANGE_COMPASS_2 = 5000^2
...
Global Const $REGION_MAP				=	_GWA2_ID_MapFromArrays($DISTRICT_NAMES, $DISTRICT_AND_REGION_IDS)
#EndRegion Locations
...
Global Const $ID_KAINENG_CITY				= _GWA2_ID_IsAnniversaryCelebration() Or _GWA2_ID_IsDragonFestival() ? $ID_KAINENG_CITY_EVENTS : $ID_DEFAULT_KAINENG_CITY
...
Global Const $ID_EYE_OF_THE_NORTH			= _GWA2_ID_IsChristmasFestival() ? $ID_CHRISTMAS_EYE_OF_THE_NORTH : $ID_DEFAULT_EYE_OF_THE_NORTH
...
Global Const $LOCATIONMAPNAMES				=	_GWA2_ID_MapFromArrays($LOCATION_IDS, $LOCATION_NAMES)
...
Global Const $ATTRIBUTES_BY_PROFESSION_MAP	=	_GWA2_ID_MapFromArrays($ALL_PROFESSION_IDS, $ALL_PROFESSION_ATTRIBUTES)
...
Global Const $WEAPON_NAMES_FROM_TYPES		= _GWA2_ID_MapFromArrays($WEAPON_TYPES_ARRAY, $WEAPON_NAMES_ARRAY)
;Global Const $WEAPON_TYPES_FROM_NAMES		= MapFromArrays($WEAPON_NAMES_ARRAY, $WEAPON_TYPES_ARRAY)
Global Const $MAP_ARMOR_TYPES				= _GWA2_ID_MapFromArray($ARMOR_TYPES_ARRAY)
Global Const $MAP_WEAPON_TYPES				= _GWA2_ID_MapFromArray($WEAPON_TYPES_ARRAY)
...
Global Const $SHIELD_MAX_DAMAGE_PER_LEVEL			=	[8,		9,		10,		11,		12,		13,		14,		15,		16,		16,		16,		16,		16]
...
Global Const $WEAPONS_MAX_DAMAGE_PER_LEVEL		=	_GWA2_ID_MapFromArrays($WEAPONS_MAX_DAMAGE_PER_LEVEL_KEYS, $WEAPONS_MAX_DAMAGE_PER_LEVEL_VALUES)
#EndRegion Type IDs
...
Global Const $MAP_CHESTS_IDS				= _GWA2_ID_MapFromArray($CHESTS_ARRAY)
...
Global Const $HERO_IDS_FROM_NAMES				=	_GWA2_ID_MapFromArrays($HERO_NAMES, $HERO_IDS)
#EndRegion Hero IDs
...
Global Const $RARITY_NAMES_FROM_IDS		= _GWA2_ID_MapFromArrays($RARITY_IDS, $RARITY_NAMES)
...
Global Const $MAP_KEYS					= _GWA2_ID_MapFromArray($KEYS_ARRAY)
#EndRegion Keys
...
Global Const $MAP_GENERAL_ITEMS		= _GWA2_ID_MapFromArray($GENERAL_ITEMS_ARRAY)
...
Global Const $DYE_NAMES_FROM_IDS	= _GWA2_ID_MapFromArrays($DYES_ARRAY, $DYES_NAMES_ARRAY)
;Global Const $DYE_IDS_FROM_NAMES	= MapFromArrays($DYES_NAMES_ARRAY, $DYES_ARRAY)
Global Const $MAP_DYES				= _GWA2_ID_MapFromArray($DYES_ARRAY)
#EndRegion Dyes
...
Global Const $GOLD_SCROLL_NAMES_FROM_IDS	= _GWA2_ID_MapFromArrays($GOLD_SCROLLS_ARRAY, $GOLD_SCROLLS_NAMES_ARRAY)
;Global Const $GOLD_SCROLL_IDS_FROM_NAMES	= MapFromArrays($GOLD_SCROLLS_NAMES_ARRAY, $GOLD_SCROLLS_ARRAY)
Global Const $MAP_BLUE_SCROLLS				= _GWA2_ID_MapFromArray($BLUE_SCROLLS_ARRAY)
Global Const $MAP_GOLD_SCROLLS				= _GWA2_ID_MapFromArray($GOLD_SCROLLS_ARRAY)
#EndRegion Scrolls
...
Global Const $BASIC_MATERIALS_ARRAY[]			= [$ID_BONE, $ID_IRON_INGOT, $ID_TANNED_HIDE_SQUARE, $ID_SCALE, $ID_CHITIN_FRAGMENT, $ID_BOLT_OF_CLOTH, $ID_WOOD_PLANK, $ID_GRANITE_SLAB, $ID_PILE_OF_GLITTERING_DUST, $ID_PLANT_FIBER, $ID_FEATHER]
...
Global Const $BASIC_MATERIAL_NAMES_FROM_IDS		= _GWA2_ID_MapFromArrays($BASIC_MATERIALS_ARRAY, $BASIC_MATERIALS_NAMES_ARRAY)
...
Global Const $MAP_RARE_MATERIALS				= _GWA2_ID_MapFromDoubleArray($RARE_MATERIALS_DOUBLE_ARRAY)
...
Global Const $RARE_MATERIAL_NAMES_FROM_IDS		= _GWA2_ID_MapFromArrays($RARE_MATERIALS_ARRAY, $RARE_MATERIALS_NAMES_ARRAY)
...
Global Const $MAP_BASIC_MATERIALS				= _GWA2_ID_MapFromArray($BASIC_MATERIALS_ARRAY)
Global Const $MAP_ALL_MATERIALS					= _GWA2_ID_MapFromArray($all_materials_array)

Global Const $MATERIALS_DOUBLE_ARRAY[][]		= [	[$ID_BONE, 1], [$ID_IRON_INGOT, 2], [$ID_TANNED_HIDE_SQUARE, 3], [$ID_SCALE, 4], [$ID_CHITIN_FRAGMENT, 5], [$ID_BOLT_OF_CLOTH, 6], [$ID_WOOD_PLANK, 7], [$ID_GRANITE_SLAB, 9], [$ID_PILE_OF_GLITTERING_DUST, 10], [$ID_PLANT_FIBER, 11], [$ID_FEATHER, 12], _
...
Global Const $MAP_MATERIAL_LOCATION				= _GWA2_ID_MapFromDoubleArray($MATERIALS_DOUBLE_ARRAY)
...
Global Const $MAP_ALCOHOLS					= _GWA2_ID_MapFromArray($ALCOHOLS_ARRAY)
Global Const $MAP_ONEPOINT_ALCOHOLS			= _GWA2_ID_MapFromArray($ONEPOINT_ALCOHOLS_ARRAY)
Global Const $MAP_THREEPOINT_ALCOHOLS		= _GWA2_ID_MapFromArray($THREEPOINT_ALCOHOLS_ARRAY)
Global Const $MAP_FIFTYPOINT_ALCOHOLS		= _GWA2_ID_MapFromArray($FIFTYPOINT_ALCOHOLS_ARRAY)
#EndRegion Alcohol
...
Global Const $MAP_SPAMMABLE_PARTY		= _GWA2_ID_MapFromArray($SPAMMABLE_PARTY_ARRAY)
Global Const $MAP_FESTIVE				= _GWA2_ID_MapFromArray($ALL_FESTIVE_ARRAY)
#EndRegion Party
...
Global Const $MAP_TOWN_SWEETS			= _GWA2_ID_MapFromArray($TOWN_SWEETS_ARRAY)
...
Global Const $MAP_SWEET_PCONS			= _GWA2_ID_MapFromArray($SWEET_PCONS_ARRAY)
...
Global Const $MAP_DP_REMOVAL_SWEETS			= _GWA2_ID_MapFromArray($DP_REMOVAL_SWEETS)
...
Global Const $SPECIAL_DROP_NAMES_FROM_IDS		= _GWA2_ID_MapFromArrays($SPECIAL_DROPS, $SPECIAL_DROPS_NAMES)
;Global Const $SPECIAL_DROP_IDS_FROM_NAMES	= MapFromArrays($SPECIAL_DROPS_NAMES, $SPECIAL_DROPS)
Global Const $MAP_SPECIAL_DROPS				= _GWA2_ID_MapFromArray($SPECIAL_DROPS)
...
Global Const $MAP_MAP_PIECES					= _GWA2_ID_MapFromArray($MAP_PIECES_ARRAY)
...
Global Const $MAP_REWARD_TROPHIES					= _GWA2_ID_MapFromArray($REWARD_TROPHIES_ARRAY)
...
Global Const $MAP_TROPHIES	= _GWA2_ID_MapFromArray($TROPHIES_ARRAY)
...
Global Const $MAP_FEATHER_TROPHIES			= _GWA2_ID_MapFromArray($FEATHER_TROPHIES_ARRAY)
...
Global Const $MAP_DUST_TROPHIES				= _GWA2_ID_MapFromArray($DUST_TROPHIES_ARRAY)
...
Global Const $MAP_BONES_TROPHIES			= _GWA2_ID_MapFromArray($BONES_TROPHIES_ARRAY)
...
Global Const $MAP_FIBER_TROPHIES			= _GWA2_ID_MapFromArray($FIBER_TROPHIES_ARRAY)
...
Global Const $ELITE_TOME_NAMES_FROM_IDS		= _GWA2_ID_MapFromArrays($ELITE_TOMES_ARRAY, $ELITE_TOMES_NAMES_ARRAY)
...
Global Const $REGULAR_TOME_NAMES_FROM_IDS	= _GWA2_ID_MapFromArrays($REGULAR_TOMES_ARRAY, $REGULAR_TOMES_NAMES_ARRAY)
;Global Const $REGULAR_TOME_IDS_FROM_NAMES	= MapFromArrays($REGULAR_TOMES_NAMES_ARRAY, $REGULAR_TOMES_ARRAY)
Global Const $MAP_TOMES						= _GWA2_ID_MapFromArray($TOMES_ARRAY)
Global Const $MAP_ELITE_TOMES				= _GWA2_ID_MapFromArray($ELITE_TOMES_ARRAY)
Global Const $MAP_REGULAR_TOMES				= _GWA2_ID_MapFromArray($REGULAR_TOMES_ARRAY)
#EndRegion Tomes
...
Global Const $MAP_CONSETS				= _GWA2_ID_MapFromArray($CONSETS_ARRAY)
...
Global Const $MAP_SUMMONING_STONES				= _GWA2_ID_MapFromArray($SUMMONING_STONES_ARRAY)
...
Global Const $MAP_PARTY_TONICS				= _GWA2_ID_MapFromArray($PARTY_TONICS_ARRAY)
...
Global Const $MAP_EL_TONICS						= _GWA2_ID_MapFromArray($EL_TONIC_ARRAY)
#EndRegion EL Tonics
#EndRegion Tonics
...
Global Const $MAP_ULTRA_RARE_WEAPONS = _GWA2_ID_MapFromArray($ultra_rare_weapons_array)
...
Global Const $MAP_RARE_WEAPONS = _GWA2_ID_MapFromArray($rare_weapons_array)
#EndRegion Items

;~ Internal helper functions to avoid circular dependency with Utils.au3

Func _GWA2_ID_MapFromArray($keys)
	Local $map[]
	For $key In $keys
		$map[$key] = 1
	Next
...
Func _GWA2_ID_MapFromDoubleArray($keysAndValues)
	Local $map[]
...
Func _GWA2_ID_MapFromArrays($keys, $values)
	Local $map[]
...
Func _GWA2_ID_IsAnniversaryCelebration()
...
Func _GWA2_ID_IsDragonFestival()
	Local $currentMonth = @MON
	Local $currentDay = @MDAY
...
Func _GWA2_ID_IsChristmasFestival()
	Local $currentMonth = @MON
	Local $currentDay = @MDAY
