...
Global Const $LOG_PATH = "C:\Users\Robert\Documents\GWA Censured X BotsHub\GWA Censured\debug_scripts\launch_disco_panic_via_gwlauncher.log"
...
ConsoleWrite("=== Launch Disco Panic via GWLauncher ===" & @CRLF)
FileDelete($LOG_PATH)
FileWrite($LOG_PATH, "=== Launch Disco Panic via GWLauncher ===" & @CRLF)
...
If IsAtCharSelect() Then
    If IsReconnectDialogShowing() Then
        ConsoleWrite("Reconnect dialog detected; dismissing before selecting DISCO PANIC" & @CRLF)
            ...
            If TimerDiff($verifyTimer) - $lastRetryMs > 10000 Then
                ...
                If IsAtCharSelect() Then
                    ...
                    If IsReconnectDialogShowing() Then
                        ...
                        Sleep(1000)
                    EndIf
                    If Not _SelectExpectedCharacterAndPressPlay($TARGET_CHARACTER) Then
