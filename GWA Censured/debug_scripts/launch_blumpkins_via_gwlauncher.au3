...
Global Const $TARGET_CHARACTER = "B L U M P K I N S"
Global Const $ACCOUNTS_PATH = "C:\Users\Robert\Documents\GWA Censured X BotsHub\GWA Censured\Accounts.json"
Global Const $LOG_PATH = "C:\Users\Robert\Documents\GWA Censured X BotsHub\GWA Censured\debug_scripts\launch_blumpkins_via_gwlauncher.log"
...
ConsoleWrite("=== Launch Blumpkins via GWLauncher ===" & @CRLF)
FileDelete($LOG_PATH)
FileWrite($LOG_PATH, "=== Launch Blumpkins via GWLauncher ===" & @CRLF)
...
If IsAtCharSelect() Then
    If IsReconnectDialogShowing() Then
        ConsoleWrite("Reconnect dialog detected; dismissing before selecting BLUMPKINS" & @CRLF)
